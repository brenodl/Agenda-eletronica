...
import br.com.agendaeletronica.service.http.HttpLoader;
import br.com.agendaeletronica.service.http.SimpleHttpLoader;
...
public class ReCaptchaImpl implements ReCaptcha {
	...
	public static final String HTTP_SERVER = "https://www.google.com/recaptcha/api.js";
	public static final String HTTPS_SERVER = "https://www.google.com/recaptcha/api.js";
	...
	public String createRecaptchaHtml(String errorMessage, Properties options) {
		...
		message += "<script  src=\"" + recaptchaServer + "\"></script>\r\n"
